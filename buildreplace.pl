...
my $dh = 'C:\Program Files (x86)\Steam\SteamApps\common\Victoria 2\mod\HPM\history\provinces\usa';
my @cfgs;
my $folder;
...
open my $keywords,    '<', 'searchbuildings.txt' or die "Can't open keywords: $!";
