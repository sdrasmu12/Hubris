...
country = {
	...
	CAMPAIGN_DURATION = 7,	-- a campaign lasts these amount of months
...
diplomacy = {
	...
	TENSION_FROM_MOVEMENT_MAX = 1.5, -- max total value no matter the size of the movement
	...
	RANK_1_TENSION_DECAY = -0.6, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.5,
	RANK_3_TENSION_DECAY = -0.4,
	RANK_4_TENSION_DECAY = -0.3,
	RANK_5_TENSION_DECAY = -0.2,
	RANK_6_TENSION_DECAY = -0.1,
	RANK_7_TENSION_DECAY = -0.08,
	RANK_8_TENSION_DECAY = -0.06,
